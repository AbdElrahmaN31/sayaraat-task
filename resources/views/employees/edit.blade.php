                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <button type="button" id="cancelImage" style="display: none;">Cancel
                                            </button>
                                        </div>
                                        ...
                                        @if($isAdmin)
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="role" class="form-control" id="role" required>
                                                    <option
                                                        value="admin" {{ $employee->role == 'admin' ? 'selected' : '' }}>
                                                        Admin
                                                    </option>
                                                    <option
                                                        value="manager" {{ $employee->role == 'manager' ? 'selected' : '' }}>
                                                        Manager
                                                    </option>
                                                    <option
                                                        value="employee" {{ $employee->role == 'employee' ? 'selected' : '' }}>
                                                        Employee
                                                    </option>
                                                </select>
                                                @error('role')
                                        ...
                                        @if($isAdmin)
                                            <div class="form-group col-md-12">
                                                ...
                                                <select id="manager_select" name="manager_id" class="form-control"
                                                        id="manager_id" required>
                                                    @foreach($managers as $manager)
                                                        <option
                                                            value="{{ $manager->id }}" {{ $employee->manager_id == $manager->id ? 'selected' : '' }}>
                                                            {{ $manager->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <input type="hidden" id="hidden_manager_id" name="manager_id"
                                                   value="{{ $currentUserId }}">
